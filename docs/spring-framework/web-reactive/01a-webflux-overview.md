...
## [](#webflux-why-reactive)Define “Reactive”
...
## [](#webflux-reactive-api)Reactive API
...
of RxJava or another reactive library. See [Reactive Libraries](../webflux-reactive-libraries.html) for more details.
...
[Coroutines](../../languages/kotlin/coroutines.html) APIs in Kotlin which provides a more imperative style of programming.
The following Kotlin code samples will be provided with Coroutines APIs.
 |

## [](#webflux-programming-models)Programming Models

The `spring-web` module contains the reactive foundation that underlies Spring WebFlux,
including HTTP abstractions, Reactive Streams [adapters](reactive-spring.html#webflux-httphandler)
for supported servers, [codecs](reactive-spring.html#webflux-codecs), and a core
[`WebHandler` API](reactive-spring.html#webflux-web-handler-api) comparable to
the Servlet API but with non-blocking contracts.

On that foundation, Spring WebFlux provides a choice of two programming models:

* 
[Annotated Controllers](controller.html): Consistent with Spring MVC and based on the
...
* 
[Functional Endpoints](../webflux-functional.html): Lambda-based, lightweight,
...
## [](#webflux-framework-choice)Applicability
...
You can return reactive types (Reactor, RxJava, [or other](../webflux-reactive-libraries.html))
...
[common API](reactive-spring.html#webflux-httphandler) so that higher-level
...
easy to [assemble](reactive-spring.html#webflux-web-handler-api) an application from Spring configuration and
[WebFlux infrastructure](dispatcher-handler.html#webflux-framework-config) and [run it](reactive-spring.html#webflux-httphandler) with a few
lines of code.
...
## [](#webflux-performance)Performance
...
## [](#webflux-concurrency-model)Concurrency Model
...
### [](#invoking-a-blocking-api)Invoking a Blocking API
...
[configure](../webflux-webclient/client-builder.html) the `WebClient` directly.
