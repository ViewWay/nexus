...
* 
`observationRegistry`: the registry to use for enabling [Observability support](../../integration/observability.html#observability.http-client.webclient).

* 
`observationConvention`: [an optional, custom convention to extract metadata](../../integration/observability.html#observability.config) for recorded observations.
...
## [](#webflux-client-builder-maxinmemorysize)MaxInMemorySize

Codecs have [limits](../webflux/reactive-spring.html#webflux-codecs-limits) for buffering data in
...
## [](#webflux-client-builder-reactor)Reactor Netty
...
### [](#webflux-client-builder-reactor-resources)Resources
...
### [](#webflux-client-builder-reactor-timeout)Timeouts
...
## [](#webflux-client-builder-jdk-httpclient)JDK HttpClient
...
## [](#webflux-client-builder-jetty)Jetty
...
## [](#webflux-client-builder-http-components)HttpComponents
